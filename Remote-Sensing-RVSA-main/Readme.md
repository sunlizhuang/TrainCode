#单卡预训练
python3 main_pretrain.py --dataset 'jl1' --model 'mae_vitae_base_patch16' --batch_size 2 --epochs 1600 --warmup_epochs 40 --input_size 224 --mask_ratio 0.75 --blr 1.5e-4  --weight_decay 0.05 --gpu_num 1 --output_dir '../mae-main/output/' --pretrain_from '../ViT-retail/vitae-b-checkpoint-1599-for-pretrain.pth'

#多卡预训练
python3 -m torch.distributed.launch --nproc_per_node 1 --master_port 10000 main_pretrain.py --dataset 'jl1' --model 'mae_vitae_base_patch16' --batch_size 2 --epochs 1600 --warmup_epochs 40 --input_size 224 --mask_ratio 0.75 --blr 1.5e-4  --weight_decay 0.05 --gpu_num 1 --output_dir '../mae-main/output/' --pretrain_from '../ViT-retail/vitae-b-checkpoint-1599-for-pretrain.pth'

#多卡微调
CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.launch --nproc_per_node 1 --master_port 20000 main_finetune.py --dataset 'nwpu' --model 'vitae_nc_base_win_rvsa' --input_size 224 --postfix 'sota' --batch_size 64 --epochs 200 --warmup_epochs 5 --blr 1e-3  --weight_decay 0.05 --split 28 --tag 0 --exp_num 1 --finetune '../ViT-retail/vitae-b-checkpoint-1599-transform-no-average.pth'

#比赛用
#fake推理
python3 run.py /Remote-Sensing-RVSA-main/Dataset/fake/image /Remote-Sensing-RVSA-main/MAEPretrain_SceneClassification/output_dir

#fake训练
CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.launch --nproc_per_node 1 --ma
ster_port 20000 fake_finetune.py --input_size 600
...
```
python3 -m torch.distributed.launch --nproc_per_node 1 --master_port 10000 main_pretrain.py \
--dataset 'nwpu' --model 'mae_vit_base_patch16' \
--batch_size 256 --epochs 1600 --warmup_epochs 40 \
--input_size 224 --mask_ratio 0.75 \
--blr 1.5e-4  --weight_decay 0.05 --gpu_num 1 \
