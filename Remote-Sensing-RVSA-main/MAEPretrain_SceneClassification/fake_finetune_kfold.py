...
def get_args_parser():
    ...
    # * Finetuning params
    parser.add_argument('--finetune', default='../ViT-retail/vitae-b-checkpoint-1599-transform-no-average.pth',
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='/Remote-Sensing-RVSA-main/Dataset/fake', type=str,
                        help='dataset path')
    ...
    parser.add_argument('--dataset', default='fake', type=str, help='type of dataset')

    parser.add_argument("--split", default='1', type=int, help='trn-tes ratio')
    ...
    parser.add_argument("--postfix", default='single', type=str, help='postfix for save folder')
