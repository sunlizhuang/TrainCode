...
from util.datasets import MillionAIDDataset,NWPURESISCDataset,JL1Dataset
...
def get_args_parser():
    ...
    parser.add_argument('--pretrain_from', default='',
                        help='pretrain from checkpoint')
    ...
    # dataset
    parser.add_argument('--dataset', default=None, type=str, choices=['millionAID','imagenet','jl1'], help='type of dataset')
...
def main(args):
    ...
    elif args.dataset == 'jl1':
        args.data_path = '/Remote-Sensing-RVSA-main/Dataset/jl1/all_img/'

        dataset_train = JL1Dataset(args.data_path, train=True,transform=transform_train)
    else:
    ...
    if args.pretrain_from:
        checkpoint = torch.load(args.pretrain_from, map_location='cpu')

        print("Load pre-trained checkpoint from: %s" % args.pretrain_from)
